// EmuHem spi_image.hpp shim
// Provides image_tag_t type and tag constants.
// Region data is stubbed since there's no SPI flash.
...
struct image_tag_t {
    constexpr image_tag_t() : c{0, 0, 0, 0} {}
    constexpr image_tag_t(char c0, char c1, char c2, char c3)
        : c{c0, c1, c2, c3} {}
...
// Stub regions (no SPI flash in emulator)
inline const region_t images{0, 0};
inline const region_t application{0, 0};
